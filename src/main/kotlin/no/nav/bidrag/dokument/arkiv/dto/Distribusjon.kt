...
data class DokDistDistribuerJournalpostRequest(
    ...
    constructor(journalpostId: Long, batchNavn: String?, brevkode: String?, tittel: String?, distribuerTilAdresse: DistribuerTilAdresse?): this(journalpostId = journalpostId) {
        batchId = batchNavn
