...
data class AvvikshendelseIntern(
    ...
    val enhetsnummer: String
        get() = detaljer[AvvikDetaljer.ENHETSNUMMER]
            ?: throw AvvikDetaljException(AvvikDetaljer.ENHETSNUMMER)
    val enhetsnummerGammelt: String
        get() = detaljer[AvvikDetaljer.ENHETSNUMMER]
    ...
    val nyttFagomrade: String
        get() = detaljer[AvvikDetaljer.FAGOMRADE]
            ?: throw AvvikDetaljException(AvvikDetaljer.FAGOMRADE)
    val utsendingsKanal: String
        get() = detaljer[AvvikDetaljer.UTSENDINGSKANAL]
