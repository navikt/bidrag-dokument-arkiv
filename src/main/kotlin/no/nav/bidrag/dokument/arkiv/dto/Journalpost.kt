    ...
    fun hentJournalStatus(): JournalpostStatus? {
        return if (isDistribusjonKommetIRetur()) {
            ...
            when (journalstatus) {
                ...
                JournalStatus.UKJENT_BRUKER -> JournalpostStatus.UKJENT
                JournalStatus.OPPLASTING_DOKUMENT -> JournalpostStatus.UNDER_OPPRETTELSE
                JournalStatus.UKJENT -> JournalpostStatus.UKJENT
                null -> null
            }
        }
    }
