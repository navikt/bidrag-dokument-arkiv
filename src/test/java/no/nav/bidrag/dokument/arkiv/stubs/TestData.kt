...
var BRUKER_ID = "123213213213";
var BRUKER_AKTOERID = "AKTOERID";
...
var TILLEGGSOPPLYSNINGER_RETUR: MutableList<Map<String, String>> = mutableListOf(mapOf("nokkel" to "retur0_2020-11-15", "verdi" to "Beskrivelse av retur"))
...
fun opprettSafResponse(
    ...
    bruker: Bruker = Bruker(BRUKER_ID, BRUKER_AKTOERID),
    dokumenter: List<Dokument> = listOf(Dokument(
