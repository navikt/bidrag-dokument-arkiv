...
public class Stubs {
  ...
  public void mockDokarkivKnyttTilAnnenSakRequest(Long journalpostId) {
    mockDokarkivKnyttTilAnnenSakRequest(journalpostId, 123213213L);
  }

  public void mockDokarkivKnyttTilAnnenSakRequest(Long journalpostId, Long nyJournalpostId) {
    try {
      stubFor(
          put(
              urlMatching(
                  "/dokarkiv" + String.format(DokarkivConsumer.URL_KNYTT_TIL_ANNEN_SAK, journalpostId)
              )
          ).willReturn(
              aClosedJsonResponse()
                  .withStatus(HttpStatus.OK.value())
  ...
  public static class VerifyStub {
    ...
    private void dokarkivKnyttTilSakerKalt(Integer times, Long journalpostId, String... contains) {
    ...
    public void dokarkivProxyTilknyttSakerIkkeKalt(Long journalpostId, String... contains) {
      dokarkivKnyttTilSakerKalt(0, journalpostId, contains);
    }

    public void dokarkivKnyttTilSakerKalt(Long journalpostId, String... contains) {
      dokarkivKnyttTilSakerKalt(1, journalpostId, contains);
    }
